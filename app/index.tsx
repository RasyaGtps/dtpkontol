  ...
  const categories = [
    ...
    { name: "Baju", icon: <FontAwesome5 name="tshirt" size={80} color="white" /> },
    { name: "Rumah", icon: <MaterialIcons name="house" size={80} color="white" /> },
    { name: "Bahasa", icon: <MaterialCommunityIcons name="translate" size={80} color="white" /> },
  ];
